              ...
              >
                ...
                <div className="p-4 sm:p-6">
                  ...
                  <div className="flex justify-between items-center flex-col sm:flex-row items-stretch sm:items-center gap-2">
                    ...
                    <button className="flex items-center justify-center gap-2 px-3 sm:px-4 py-2 bg-gray-300/10 hover:bg-white/10 border border-white/10 text-white rounded-lg font-medium transition-all text-xs sm:text-sm">
